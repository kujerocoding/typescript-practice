    ...
    <section id='contactus' className='mx-auto w-5/6 pt-24 pb-32'>
        <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
            ...
            >
                ...
                <p className='my-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor, placeat corrupti rerum ab excepturi adipisci totam omnis facere at, architecto, tenetur quidem ullam! Dolorem ullam eius quaerat similique ratione. Illum, soluta pariatur repellat incidunt praesentium voluptates cupiditate ratione sed aperiam!</p>
            </motion.div>
            {/* FORM AND IMAge */}
                    ...
                    <input className={inputStyles} 
                        ...
                        {errors.name && (
                            <p className='mt-1 text-primary-500'>
                                ...
                                {errors.name.type === "max-length" && "Max length is 100 char."}
                            </p>
                        )}
                    <input className={inputStyles} 
                            type='text' 
                    ...
                    <textarea className={inputStyles} 
                        ...
                        {errors.message && (
                            <p className='mt-1 text-primary-500'>
                                ...
                                {errors.message.type === "max-length" && "Max lenght is 2000 char."}
                            </p>
                        )}
